      ...
      >
        <Col span={12} className="Home-about-content Home-content">
          <Row type="flex" align="middle" justify="start">
            ...
            <Col offset={4} md={14}>
              <p>
                Mi name is <b>Jorge Pérez Cuentas</b>. I'm Software Engineer
                focused in Web Development and soon in AI. In the areas of: Ux -
                UI Desing and FullStack Development.
              </p>
            </Col>
            <Col offset={5} md={16}>
              <Row
